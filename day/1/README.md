...
given them the tools they need to prevent their usual Christmas
emergency. For example, they now know that the North Pole decorations
need to be finished soon so that other critical tasks can start on
time.
...
on each day; the second puzzle is unlocked when you complete the
...
0x434C49434B until further notice."
